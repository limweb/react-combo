...
`onActiveTagIndexChange(index)` | Function | - | callback called when activeTagIndex changes 
`activeTagIndex` | Int | - | specify which tag is active, specify it's index, controlled version of `defaultActiveTagIndex`
`defaultActiveTagIndex` | Int | - | specify which tag is active at first render, 
